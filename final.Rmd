...
g2 <- ggplot(dd2,
  ...
  geom_jitter(col = "red",
              alpha = 0.1,
              height = 0, width = 0.1, data = outliers) +
  geom_boxplot(outlier.shape = NA) +
  facet_wrap(~variable, scales = "free",
             nrow = 5) +
  theme_pub(type = 'boxplot') +
  theme(legend.position = "none")
...
wines_trans <- wines %>% 
  mutate(log_total.sulfur.dioxide = log(total.sulfur.dioxide),
         ...
         log_residual.sugar = log(residual.sugar)) %>% 
...
g2 <- ggplot(dd_trans,
  ...
  geom_jitter(col = "red",
              alpha = 0.1,
              height = 0, width = 0.1, data = outliers2) +
  geom_boxplot(outlier.shape = NA) +
  facet_wrap(~variable, scales = "free",
             nrow = 5) +
  theme_pub(type = 'boxplot') +
